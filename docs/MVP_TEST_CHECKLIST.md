...
- [ ] LocalStorage remains source of truth, and optional Clerk/Supabase connection works in a best-effort cloud-save-only manner for sessions and vocabulary (no cloud load/sync/conflict resolution yet)
