...
- Profile & Settings is owner-only. It does not create public profile pages, and never publishes or renders transcripts, retry transcripts, vocabulary sentence history, AI corrections, article URLs, weaknesses, retry tasks, CSV/session raw content, XP event source IDs, or private notes.
