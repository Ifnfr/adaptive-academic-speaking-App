...
export function ProgressView({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      {/* Left Column: Stats Section - Renders second on mobile, first on desktop */}
      <div className="flex flex-col gap-6 order-2 lg:order-1 lg:col-span-1">
      ...
      {/* Right Column: Quests Section - Renders first on mobile, second on desktop */}
