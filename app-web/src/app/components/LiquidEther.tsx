...
`;
    ...
    class Advection extends ShaderPass {
      ...
      update(...args: unknown[]) {
        const { dt: dtVal, isBounce, BFECC: bfecc } = (args[0] || {}) as { dt?: number; isBounce?: boolean; BFECC?: boolean };
    ...
    class Pressure extends ShaderPass {
      ...
      update(...args: unknown[]) {
        const { vel, pressure: pressureVal } = (args[0] || {}) as { vel?: THREE.WebGLRenderTarget; pressure?: THREE.WebGLRenderTarget };
      ...
      update() {
        ...
        if (this.options.isViscous) {
          vel = this.viscous.update({
            ...
            dt: this.options.dt
          }) as THREE.WebGLRenderTarget | undefined;
        }
